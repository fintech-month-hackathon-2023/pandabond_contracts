...
contract DualCurrencyBond is ERC1155 {
    ...
    function mint(address to, uint256 bondQuantity, IDualCurrencyBond.BondMetadata memory metadata) public onlyFactory returns(uint256 id) {
        id = _id.current();
        _id.increment();
    ...
    function bondMetadataAsStruct(uint256 id) public view returns (IDualCurrencyBond.BondMetadata memory){
